...
<body>
	...
	<div class="container">
	<h4><spring:message code="editDriver.info"/></h4>

	
		<div class="row">
		
		<spring:url value="/drivers/update" var="formUrl"/>
			...
			<form:form action="${formUrl}" method="POST" modelAttribute="driver">
				...
				<div class="form-group">
					...
					<form:input readonly="true" id="personalIdentificationNumber" path="personalIdentificationNumber" maxlength="20" cssClass="form-control"/>
